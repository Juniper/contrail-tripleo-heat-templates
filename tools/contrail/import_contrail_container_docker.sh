...
do
  ...
  docker pull ${registry}/${contrailImageName}:${tag}
  docker tag ${registry}/${contrailImageName}:${tag} 192.168.24.1:8787/${contrailImageName}:${tag}
  docker push 192.168.24.1:8787/${contrailImageName}:${tag}
done
