# sriov_bond_vlan
NIC configuration:    
~/tripleo-heat-templates/config/network/contrail/compute-nic-sriov-bond-vlan-config.yaml   
```
...
```
resource_registry:
  OS::TripleO::ContrailSriov::Net::SoftwareConfig: ../../network/config/contrail/compute-nic-sriov-bond-vlan-config.yaml
```
