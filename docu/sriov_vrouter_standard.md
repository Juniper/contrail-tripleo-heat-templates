# sriov_standard
NIC configuration:    
~/tripleo-heat-templates/config/network/contrail/compute-nic-sriov-config.yaml   
```
...
```
resource_registry:
  OS::TripleO::ContrailSriov::Net::SoftwareConfig: ../../network/config/contrail/compute-nic-sriov-config.yaml
```
